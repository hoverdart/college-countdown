...
export default function Home() { //quote is gray-400
  return (
    <>
    <NavBar />
    <h5 className="text-sm font-bold text-gray-400 gap-2 px-6 font-[family-name:var(--font-geist-sans)] underline decoration-sky-500">Double-click on Any of Your Colleges to Deselect Them.</h5>
